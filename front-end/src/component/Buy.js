...
<div class="col-md-8">
    ...
    <div class="card3 p-3">
        ...
        <div class="inputbox mt-3"> <input type="text" name="name" class="form-control" required="required"/> <span>Name on card3</span> </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="inputbox mt-3 mr-2"> <input type="text" name="name" class="form-control" required="required"/> <i class="fa fa-credit-card3"></i> <span>card3 Number</span> 
...
<div class="col-md-4">
    ...
    <div class="card3 card3-blue p-3 text-white mb-3">
